...
export default {
  ...
  mounted() {
    axios({
      ...
      var option = ['line1', 'bar1']
      for (var i in result) {
        this.$data[option[i]].title.text = result[i]['title']
        this.$data[option[i]].xAxis.data = result[i]['xAxis']
        this.$data[option[i]].series[0].name = result[i]['series']['name']
        this.$data[option[i]].series[0].type = result[i]['series']['type']
        this.$data[option[i]].series[0].data = result[i]['series']['data']
      }
